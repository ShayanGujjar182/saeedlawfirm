		...
		try {
			...
			if (data.success) {
				...
				setStatus({
					...
					message:
						data.message ||
						'Something went wrong. Please call or WhatsApp us at +92 319 4959420.'
				})
			}
		} catch {
			setStatus({
				type: 'error',
				message:
					'We could not send your message. Please call or WhatsApp us at +92 319 4959420.'
			})
		}
	}
	...
	return (
		<>
			<Head>
				...
				<meta
					name="description"
					content="Call or WhatsApp +92 319 4959420 to reach Saeed Law Firm in DHA Phase 3 Lahore. Free legal consultation. Monday to Friday 9 AM to 6 PM."
				/>
			...
			<div className="bg-navy-900 py-16 px-6 text-center">
				...
				<h1 className="font-serif text-3xl md:text-4xl font-semibold text-white mb-3">
					Contact Saeed Law Firm in Lahore
				</h1>
			...
			<div className="bg-gray-50 py-16 px-6">
				<div className="max-w-2xl mx-auto">
					<p className="text-center text-navy-700 mb-10 text-sm leading-relaxed">
						Reach Saeed Law Firm by phone, WhatsApp, or email. Bilal Saeed, Advocate,
						handles your matter personally. We offer a free initial consultation and
						have been serving clients in Lahore since 1975.
					</p>

					{/* Contact cards */}
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
						<a
							href="https://www.google.com/maps/search/?api=1&query=Saeed+Law+Firm+DHA+Phase+3+Lahore"
						...
						>
							...
							<span className="text-sm text-navy-700 font-medium">
								Y Block Main Market, Sector Y, DHA Phase 3, Lahore 54793
							</span>
						</a>
					...
					>
						...
						<p className="text-sm text-navy-700 mb-6">
							Tell us which legal service you need. For a faster response, call or
						...
						<div className="mb-5">
							...
							<select
								...
								className="block w-full px-4 py-2.5 text-navy-900 bg-white border border-gray-300 rounded-md focus:border-gold-500 focus:outline-none focus:ring-1 focus:ring-gold-500 transition-colors"
							>
						...
						<div className="mb-6">
							...
							<textarea
								...
								className="block w-full px-4 py-2.5 text-navy-900 bg-white border border-gray-300 rounded-md focus:border-gold-500 focus:outline-none focus:ring-1 focus:ring-gold-500 transition-colors resize-none"
