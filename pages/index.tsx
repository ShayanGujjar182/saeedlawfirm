...
const BENEFITS = [
  { title: 'Transparent from Day One',  body: 'You get a clear view of your case, realistic timelines, and honest fees. No hidden costs or vague jargon. We tell you what we think, what it costs, and how we\'ll get it done.' },
  { title: 'Courtroom Experience',      body: 'Fifty years of cases before the Lahore High Court, District Courts, and Family Courts. We know how these courts actually run, which shapes how we prepare and where we push.' },
  { title: 'Strategy That Works',   body: 'There is no template here. Some cases are won in the courtroom, others in a well-judged settlement or mediation, and we are honest with you about which one yours looks like.' },
  { title: 'Focused on Your Outcome', body: 'Your goals drive our work. We measure success by your result, not by billable hours. We move fast where speed matters and take time when the case demands it.' },
]

export default function Home() {
  const pageTitle = 'Law Firm in Lahore | Saeed Law Firm'
  const pageDescription = 'Saeed Law Firm is a trusted law firm in Lahore, established 1975. 50+ years and 800+ cases across family, criminal, property, tax and immigration law.'
  ...
  return (
    <div>
      <Head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: jsonLd(breadcrumbSchema([{ name: 'Home', url: SITE_URL }])) }} />
      </Head>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row md:items-center gap-12">
          <div className="w-full md:w-1/2 max-w-xl">
            ...
            <p className="text-navy-700 text-base leading-relaxed mb-4 max-w-md">
              Saeed Law Firm has served Lahore since 1975. We&apos;re a full-service law firm dedicated to clear, ethical legal counsel and strong courtroom advocacy. Led by Bilal Saeed, Advocate, our team has handled 800+ cases across family law, criminal defense, property disputes, tax matters, immigration, and civil litigation.
            </p>
            <p className="text-navy-700 text-base leading-relaxed mb-4 max-w-md">
              When you need a law firm in Lahore you can trust, we pair practical advice with hard courtroom representation. We work before the Lahore High Court, District Courts, and Family Courts.
            </p>
            <p className="text-navy-700 text-base leading-relaxed mb-8 max-w-md">
              Some clients come to us mid-crisis with a hearing days away. Others want steady counsel for a business or family matter. Either way, you get a clear read on your position and a plan to act on it.
            </p>
      ...
      <div className="bg-gold-600 py-10 px-6 text-center">
        ...
        <p className="text-white/90 mb-5 max-w-xl mx-auto text-sm">
          Book a consultation and we will tell you, in plain terms, whether you have a case and what it will take to win it.
        </p>
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center gap-12">
          ...
          <div className="w-full md:w-1/2">
            <p className="text-gold-600 text-sm font-semibold uppercase tracking-widest mb-2">About Saeed Law Firm</p>
            ...
            <p className="text-navy-700 leading-relaxed mb-4">
              Saeed Law Firm is a full-service law firm in Lahore with 50 years of courtroom experience. We represent individuals and businesses across family law, criminal defense, property disputes, taxation, immigration, and civil litigation. Our lawyers handle cases in the Lahore High Court, District Courts, and Family Courts.
            </p>
            <p className="text-navy-700 leading-relaxed mb-4">
              We believe in straightforward advice, transparent fees, and your right to know exactly where your case stands. Most clients tell us that is the part other firms skip. We don&apos;t promise shortcuts; we deliver results through thorough preparation and skilled advocacy.
            </p>
            <p className="text-navy-700 leading-relaxed mb-8">
              A family matter, a criminal charge, a property boundary, a business contract gone wrong: each one gets the same focused preparation and the years of Lahore courtroom experience behind it.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto text-sm leading-relaxed">
              Clients pick us for reasons that hold up after the first meeting. We have spent five decades in Lahore courtrooms, we quote fees before we start, and the lawyer you meet is the one who runs your case. Here is what that looks like in practice.
            </p>
          </div>
      ...
      <section className="bg-white py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-gold-600 text-sm font-semibold uppercase tracking-widest mb-3">Why Clients Choose Saeed Law Firm</p>
          <blockquote className="font-serif text-xl md:text-2xl text-navy-900 italic leading-relaxed mb-6">
            &ldquo;We listen first, then build the case around your situation rather than a standard template. You get lawyers who are measured on whether your matter goes well, not on the hours billed.&rdquo;
          </blockquote>
          <div className="flex items-center justify-center gap-3 mb-8">
            <div className="w-8 h-px bg-gold-600" />
            <span className="text-gold-600 text-sm font-semibold tracking-widest uppercase">Saeed Law Firm</span>
            <div className="w-8 h-px bg-gold-600" />
          </div>
          <p className="text-navy-700 mb-8 max-w-xl mx-auto text-sm leading-relaxed">
            Ready to move forward? Contact us today for a consultation. Whether you need advice on a family matter, criminal defense, property dispute, or business issue, we&apos;re here to help.
          </p>
          <Link href="https://wa.me/+923194959420" className="btn-gold">Call Now</Link>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16 px-6 border-t border-gray-200">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
            <Link href="/lawyers-in-lahore" className="p-5 bg-white border border-gray-200 rounded-lg hover:border-gold-400 transition-colors text-center">
              <p className="font-serif font-semibold text-navy-900 text-sm">All Lawyers &amp; Services</p>
              <p className="text-xs text-gold-600 mt-2">Browse our full legal service hub</p>
            </Link>
            <Link href="/courts" className="p-5 bg-white border border-gray-200 rounded-lg hover:border-gold-400 transition-colors text-center">
              <p className="font-serif font-semibold text-navy-900 text-sm">Courts We Practice Before</p>
              <p className="text-xs text-gold-600 mt-2">Lahore High Court, District Courts, Family Courts</p>
            </Link>
            <Link href="/areas" className="p-5 bg-white border border-gray-200 rounded-lg hover:border-gold-400 transition-colors text-center">
              <p className="font-serif font-semibold text-navy-900 text-sm">Areas We Serve</p>
              <p className="text-xs text-gold-600 mt-2">Service coverage across Lahore</p>
            </Link>
            <Link href="/about" className="p-5 bg-white border border-gray-200 rounded-lg hover:border-gold-400 transition-colors text-center">
              <p className="font-serif font-semibold text-navy-900 text-sm">About Us</p>
              <p className="text-xs text-gold-600 mt-2">Meet our team and firm history</p>
            </Link>
            <Link href="/what-we-do" className="p-5 bg-white border border-gray-200 rounded-lg hover:border-gold-400 transition-colors text-center">
              <p className="font-serif font-semibold text-navy-900 text-sm">What We Do</p>
              <p className="text-xs text-gold-600 mt-2">Our approach to legal representation</p>
            </Link>
            <Link href="/contact" className="p-5 bg-white border border-gray-200 rounded-lg hover:border-gold-400 transition-colors text-center">
              <p className="font-serif font-semibold text-navy-900 text-sm">Contact Us</p>
